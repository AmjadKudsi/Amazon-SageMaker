# complete the final steps to start training
...
source_code = SourceCode(
    source_dir=".",           # Directory containing the training script and any additional code
...
# TODO: Create the input_data list containing one InputData object
# - Set channel_name="train" for the input channel name
# - Set data_source=S3_TRAIN_DATA_URI for the S3 URI where training data is stored
input_data = [
    InputData(
        channel_name="train",
...
try:
    # TODO: Call the train() method on model_trainer to start the training job asynchronously
    # - Set input_data_config=input_data to specify the input data configuration
    # - Set wait=False to make the call asynchronous (non-blocking)
