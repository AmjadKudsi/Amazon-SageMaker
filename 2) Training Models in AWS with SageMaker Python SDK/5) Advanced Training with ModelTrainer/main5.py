# work with a model evaluation script that downloads and tests a trained model
...
training_jobs = sagemaker_session.sagemaker_client.list_training_jobs(
    ...
    # TODO: Add NameContains parameter to filter for ModelTrainer jobs using 'sklearn-modeltrainer'
    NameContains='sklearn-modeltrainer'
)

# TODO: Extract the training job name from the first job summary in the list
...
try:
    # TODO: Use sagemaker_session.describe_training_job() to get details about the selected training job by name
    training_job_details = sagemaker_session.describe_training_job(TRAINING_JOB_NAME)
    
    # TODO: Extract the model S3 URI from training_job_details using the ModelArtifacts and S3ModelArtifacts path
