# complete the job monitoring section
...
try:
    ...
    # TODO: Access the latest training job information using model_trainer._latest_training_job
    latest_job = model_trainer._latest_training_job
    
    # TODO: Print the training job name using the training_job_name attribute
    print(f"Training job name: {latest_job.training_job_name}")
    
    # TODO: Print the training job status using the training_job_status attribute
