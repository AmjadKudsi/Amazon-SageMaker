...
sample_data = {
    ...
    "Latitude": 37.39,
    "Longitude": -122.08,
    #"RoomsPerHousehold": 2.182857142857143  # TODO: Remove this feature to trigger error
}
...
try:
    ...
    # TODO: Check if response.status_code == 200
    ...
    # TODO: Add else block that prints error status code and response text
    else:
