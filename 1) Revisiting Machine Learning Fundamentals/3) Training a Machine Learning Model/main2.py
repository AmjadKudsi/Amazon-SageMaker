# build a LinearRegression model and train it on the California housing data
...
# TODO: Create the LinearRegression model
model = LinearRegression()

# TODO: Fit the model to the training data using X_train and y_train
