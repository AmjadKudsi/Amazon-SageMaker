# enhance the step iteration loop to extract complete timing information and handle edge cases gracefully
...
if not executions:
    ...
    for step in steps:
        ...
        # TODO: Extract the StartTime from the step using get() method with 'Not started' as default value
        step_start = step.get('StartTime', 'Not started')
        
        # TODO: Check if the step has started (StartTime is not 'Not started') and print the start time
        if step_start != 'Not started':
            print(f"Started: {step_start}")
        
        # TODO: Check if the step has an 'EndTime' field (step has completed)
            # TODO: Extract the EndTime from the step
            # TODO: Calculate the step duration by subtracting StartTime from EndTime
            # TODO: Print both the end time and duration
        ...
        # TODO: Check if the step status is 'Failed' and if 'FailureReason' exists in the step
