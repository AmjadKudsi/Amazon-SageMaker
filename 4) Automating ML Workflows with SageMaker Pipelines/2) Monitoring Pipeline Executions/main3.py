# add duration calculation logic to your monitoring script
...
if not executions:
    ...
    # TODO: Check if the execution has completed by looking for 'LastModifiedTime' in execution_details, if it exists:
        # TODO: Extract it from execution_details
        # TODO: Calculate the duration by subtracting start_time from end_time
