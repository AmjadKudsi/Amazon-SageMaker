# time to bring everything together by creating the training step that properly connects to the preprocessing step's output
...
# TODO: Create the training step that connects to the processing step output
# - Set the step name
...
# TODO: Add training_step to the steps list along with processing_step
pipeline = Pipeline(
    name=PIPELINE_NAME,
