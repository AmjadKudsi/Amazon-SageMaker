# set thePIPELINE_NAME to "california-housing-training-pipeline" to match the pipeline you created in the previous exercise

import sagemaker
from datetime import datetime, timedelta

# TODO: Define the pipeline name to monitor (use "california-housing-training-pipeline")
