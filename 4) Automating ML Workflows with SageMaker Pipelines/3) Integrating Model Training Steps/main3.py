# make coordinated changes to both your preprocessing and training steps
# The requirements have changed: the preprocessing step should now output the training data with the name "training_dataset" instead of "train_data
# and the training step needs to be updated to reference this new output name
...
processing_step = ProcessingStep(
    ...
    outputs=[
        # TODO: Update the output_name to "training_dataset"
...
training_step = TrainingStep(
    ...
    estimator=estimator,
    inputs={
        # TODO: Update the output reference to match the new output name from the processing step
        "train": sagemaker.inputs.TrainingInput(
            s3_data=processing_step.properties.ProcessingOutputConfig.Outputs["training_dataset"].S3Output.S3Uri
        )
    }
)
