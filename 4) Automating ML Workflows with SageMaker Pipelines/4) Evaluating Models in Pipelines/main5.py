# Set PIPELINE_NAME to "california-housing-evaluation-pipeline" to connect to the complete workflow you've built

import sagemaker
from datetime import datetime, timedelta

# TODO: Define the pipeline name to monitor (use "california-housing-evaluation-pipeline")
