# add the evaluation step to the pipeline so that your workflow automatically processes data, trains a model, and evaluates its performance in sequence
...
# TODO: Include the evaluation step to the pipeline
pipeline = Pipeline(
    name=PIPELINE_NAME,
