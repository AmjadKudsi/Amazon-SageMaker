# fill in the correct SageMaker file paths in the data_processing.py script to match exactly what you configured in your ProcessingStep from the previous task
...
if __name__ == "__main__":
    # TODO: Set the input data path where SageMaker mounts the raw data
    ...
    # TODO: Create the train output directory using SageMaker's path convention
    os.makedirs("/opt/ml/processing/train", exist_ok=True)
    # TODO: Create the test output directory using SageMaker's path convention
    ...
    # TODO: Save training data to the correct SageMaker output path
    train_data.to_csv("", index=False)
    
    # TODO: Save test data to the correct SageMaker output path
