# transform a registered model from SageMaker's model registry into a live, serverless endpoint ready to handle real-world predictions
...
try:
    ...
    # TODO: Create a ModelPackage object using the role, model_package_arn, and sagemaker_session
    model = ModelPackage(
        role=SAGEMAKER_ROLE,
