# create two interconnected components that work together to evaluate model quality and make deployment decisions automatically
...
# TODO: Create a ConditionGreaterThanOrEqualTo condition that checks if the R-squared score is >= 0.6
...
# TODO: Create a ConditionStep that only executes registration when the condition is met
...
# TODO: Replace register_step with condition_step in the pipeline steps list
pipeline = Pipeline(
    name=PIPELINE_NAME,
