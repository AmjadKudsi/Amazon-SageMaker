# configure the serverless infrastructure settings and launch your model into production
...
ENDPOINT_NAME = "sklearn-serverless-endpoint-v1"
...
try:
    ...
    print(endpoint_desc["EndpointStatus"])
