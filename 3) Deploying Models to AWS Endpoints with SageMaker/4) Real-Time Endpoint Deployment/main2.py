# Change the INSTANCE_TYPE from "ml.m5.large" to "ml.m5.xlarge" to provide more compute power and memory for the model
# Update the INSTANCE_COUNT from 1 to 2 to distribute load across multiple instances
...
# TODO: Change the instance type to "ml.m5.xlarge" for better performance
INSTANCE_TYPE = "ml.m5.xlarge"
# TODO: Change the instance count to 2 to handle higher traffic volumes
INSTANCE_COUNT = 2
