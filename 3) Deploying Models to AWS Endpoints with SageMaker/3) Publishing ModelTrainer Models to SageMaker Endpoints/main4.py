# set the ENDPOINT_NAME variable to match the name of the ModelTrainer endpoint
...
# TODO: Set the name of the deployed SageMaker endpoint to use for inference
