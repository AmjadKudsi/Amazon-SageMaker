# Use the provided serverless configuration and call the deploy() method on your model object to start the deployment asynchronously
# Remember to set a unique endpoint name—this is important if you plan to run the deployment more than once, as SageMaker requires each endpoint to have a distinct identifier
...
# TODO: Set a unique name for the SageMaker endpoint to be created
...
try:
    ...
    # TODO: Deploy the model as a serverless endpoint with the unique endpoint name
